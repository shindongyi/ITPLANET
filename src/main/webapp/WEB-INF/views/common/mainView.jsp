...
<link rel="stylesheet" href="<%=request.getContextPath()%>/common/css/asdf.css">

<%-- <link rel="stylesheet" href="<%=request.getContextPath()%>/views/common/aaa.css">
<link rel="stylesheet" href="<%=request.getContextPath()%>/views/common/bbb.css"> --%>
		...
		<div class="hd_top">
			<h1 class="sd">
				<a href="<%=request.getContextPath()%>/index.jsp"><img
					...
					src="<%=request.getContextPath()%>/common/image/itplanet.png"
					alt="IT PLANET"></a>
			</h1>
		</div>
	</div>
