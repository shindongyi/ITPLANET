	...
	<div class="boardbox">
		...
		<div class="boxrow">
			<div class="boxrow-top">
				<h1 class="subtext">공모전 수정</h1>
			</div>
			<!--  enctype은 전송되는 데이터 형식을 설정한다. -->
			<form name='writeform' id='writeform'
				action='${ contextPath }/competitionUpdate.do' method='post'
					...
					<tbody>
						...
						<tr>
							...
							<td class="pnawtd"><input name="cTitle"
								...
								type="text" placeholder="공모전 이름을 입력하세요." value="${competition.cTitle }"/>
								<input type="hidden" name="cId" value="${competition.cId }"/>
							</td>
						</tr>
						<tr class="first">
							<th>공모전 접수기간</th>
							<td class="pnawtd"><input type="date" name="startDate" value="${ competition.cStartDate }">
								~ <input type="date" name="endDate" value="${ competition.cDueDate }"></td>
						</tr>

						<tr>
							<th scope="row">공모전 주소</th>
							<td class="pnawtd"><input name="cAddress" id="address"
								class="inputTypeText" style="width:80%;" type="text"
								placeholder="공모전 주소" value="${ competition.cAddress }">
						...
						<tr>
							...
							<td class="pnawtd"><input name="cPhone"
								class="inputTypeText" style="width: 80%;" type="text"
								placeholder="전화번호" value="${ competition.cPhone }"></td>
						</tr>
							...
							<td>
								<div id="titleImgArea">
									<img id="titleImg" name="titleImg" width="600" height="600"
										tabindex="0" src="${ contextPath }/resources/compeloadFiles/${cAttachment.changeName}">
								</div>
							</td>
						</tr>
						<tr>
							...
							<td class="write pnawtd"><textarea name='cContent'
									style='width: 100%; height: 200px; resize:none;'>${ competition.cContent }</textarea></td>
						</tr>
						<tr>
							<th>사진 첨부</th>
							<td>
